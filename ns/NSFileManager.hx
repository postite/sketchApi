...
extern class NSFileManager{
	...
	public inline  function createDirectoryAtPath(path:String,_withIntermediateDirectories:Bool,?_attributes:Dynamic=null,?_error:Dynamic=null):Bool{
		...
		return untyped this.createDirectoryAtPath_withIntermediateDirectories_attributes_error(path,_withIntermediateDirectories,_attributes,_error);
	}
