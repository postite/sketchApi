...
//make it overload 
// static inline function dataForSlice(s:SLICE,format:Dynamic,colorSpace:Dynamic,honorSaveForWeb:Bool):Dynamic{
// 	return untyped dataForSlice
// }
...
+ (id)dataForSlice:(id)arg1 format:(id)arg2 colorSpace:(id)arg3 honorSaveForWeb:(BOOL)arg4;
+ (id)dataForSlice:(id)arg1 format:(id)arg2 colorSpace:(id)arg3;
+ (id)dataForSlice:(id)arg1 format:(id)arg2;
...
- (id)_dataForSlice:(id)arg1 format:(id)arg2;
- (id)dataForSlice:(id)arg1 format:(id)arg2;
